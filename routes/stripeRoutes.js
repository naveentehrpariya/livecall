...
const { disable_pricing_plan, create_pricing_plan, update_pricing_plan, subscribe, pricing_plan_lists, my_subscriptions, confirmSubscription, subscriptionRenew } = require('../controllers/stripeController');
...
router.route('/my-subscriptions').get(validateToken, cacheMiddleware, my_subscriptions);
